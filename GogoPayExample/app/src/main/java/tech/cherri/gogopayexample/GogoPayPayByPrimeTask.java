...
public class GogoPayPayByPrimeTask {
    private final static String TAG = GogoPayPayByPrimeTask.class.getSimpleName();
    ...
    public GogoPayPayByPrimeTask(Context context, String prime, String details) {
        ...
        try {
            ...
            resultUrl.put("go_back_url", "https://www.google.com.tw");
            ...
            jsonRequest.put("instalment", 3);
            jsonRequest.put("three_domain_secure", true);
