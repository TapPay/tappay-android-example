...
public class OpPayPayByPrimeTask {
    private final static String TAG = OpPayPayByPrimeTask.class.getSimpleName();
    ...
    public OpPayPayByPrimeTask(Context context, String prime, String details) {
        this.details = details;
        this.mainActivity = (MainActivity) context;

        String tapPayServerUrl = TPDSetup.getInstance(context).getServerType().equals(TPDServerType.Production) ?
                TPDUrls.PRODUCTION_URL : TPDUrls.SANDBOX_URL;
        Log.d(TAG,"tapPayServerUrl: " + tapPayServerUrl);
        this.targetUrl = tapPayServerUrl + Constants.TAPPAY_PAY_BY_PRIME_URL;
        ...
        try {
            ...
            cardHolder.put("phone_number", "0988168168");
